"""Domain errors and their safe HTTP representation."""
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def analysis_not_found(_: Request, exc: AnalysisNotFoundError) -> JSONResponse:
    ...
    async def analysis_not_cancellable(_: Request, exc: AnalysisNotCancellableError) -> JSONResponse:
